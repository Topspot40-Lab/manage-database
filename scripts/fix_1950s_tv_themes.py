...
def main():
    ...
    p.add_argument("--in", dest="inp", required=True, help="Input JSON path (e.g. data/json_files/genredecade/1950s/1950s_tv_themes_en.json)")
    ...
    for lst in tracklists:
        for t in lst:
            ...
            if not raw_name:
                ...
                t["artist_name"] = canon
                # prefer existing display name, else mirror canonical name
